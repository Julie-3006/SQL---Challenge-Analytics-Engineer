...
FROM (
    SELECT
        ...
        ROW_NUMBER() OVER (
            PARTITION BY DATE_FORMAT(O.Date_Order, '%m-%y')
...
-- STORED PROCEDURE OPCION 1 --

DELIMITER $$

DROP PROCEDURE IF EXISTS `ITEM_STATUS_PROCEDURE` ; 
...
BEGIN
    ...
    DELETE FROM ITEM_STATUS_LATEST ;
